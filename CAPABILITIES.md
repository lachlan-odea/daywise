...
> relevant capability bullet(s) **and** add a dated entry to the Changelog. Keep tracking
> everything until we cut **v0.1**, at which point this becomes formal release-notes input.
